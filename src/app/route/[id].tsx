...
import { useFavorite } from "@/features/routes/favorite";
        ...
        <>
          <View className="flex-row gap-2 justify-around">
            <View className="flex-row gap-2 items-center">
              <Mountain />
              <Text>
                <Text className="font-bold">{route.hoogtemeters}</Text>
                Hoogtemeters
              </Text>
            </View>
            <View className="flex-row gap-2 items-center">
          ...
          <View className="mt-4 gap-2">
            <Text className="text-md">
              <Text className="font-bold">Provincie:</Text> {route.provincie}
            </Text>
            <Text className="text-md">
              <Text className="font-bold">Address: </Text> {route.address}
            </Text>
          </View>
          <View>
            <Text className="text-md mt-4">{route.omgeving}</Text>
          </View>
          <View className="flex-row flex-wrap gap-2 mt-2">
            {route.marking.map((mark, index) => (
              <View
                key={index}
